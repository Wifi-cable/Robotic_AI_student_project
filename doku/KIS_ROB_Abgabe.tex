...
{\small\textbf{\textit{Stichworte}\textendash{}\textendash{}Roboter, ROS, Raspi, Neuronale Netze, Arduino}}
	...
	Tiziano 
	Fiorenzanis Code. Es wurde eine Abzweigung seines Github-Repositoriums 
	erstellt. Auf 
	...
	ein Marker wurde  genommen der sich gut rotieren und spiegeln lässt.
	...
	Diese werden durch verschiedene Topics (Themen) kommuniziert, die in den Abbildungen als Rechteck dargesteltt werden.
	...
	\begin{itemize}
		...
		Dieser String endhält eine Richtungsangabe wie \say{Left} oder 
		\say{Forward}. Das senden über W-lan ist nötig da sich die  
	...
	\begin{enumerate}
		...
		Dieser hat eine maximale Reichweite von vier Meter.
	...
	Der erste Entwurf unseres Neuronalen Netzes war stark angelehnt an F. Grovers Beispielnetz aus \glqq Artificial Intelligence for Robotics\grqq \cite{govers2018artificial}. 
...
threadsafe. Das erschien anfangs kein Problem, da keine parallele 
	Programmierung geplant war. Ein Prototyp-Programm mit Anwendung vom 
	neuronalem Netz lief problemlos auf Mac mit Python 3 (ohne ROS 
	...
	Die abschließende Ursache konnte zum Zeitpunkt des Papers nicht geklärt 
	werden.
