...
{\small\textbf{\textit{Stichworte}\textendash{}\textendash{}Roboter, ROS, Raspi, Neuronale Netze, Arduino}}
	...
	\begin{figure} [!h]
		...
		\caption{Der optische Marker auf den das Neuronale Netz 
		trainiert wird. Der Roboter rosBerry wird versuchen den Marker zu 
		finden auf ihn zuzufahren}
		\label{Marker}
	\end{figure}
	...
	% ? Besser als das hier: ?
	% Innerhalb der anderen Komponente Roboter - unser rosBerry - befindet 
	%sich die beiden Hardware-Elemente Raspberry Pi und ein Arduino. 
	%Roscore läuft auf dem Raspberry Pi und ein Node - für den 
	%Ultraschallsensor - auf dem Arduino.
...
roslaunch ki_nav start_AI.launch
	...
	\begin{figure}[h]
		...
		Servomotor befestigt ist. Dieser Servo ist einer von zwei Motoren, er ist 
	...
	\begin{figure} %[t]
		...
		\caption{Auszug aus Hersteller Datenblatt: Differenzialgetriebe. Auch 
		wenn der Roboter Differenzialgetriebe hat, ist die Lenkung eine 
		Ackermann Lenkung. Der Roboter hat keine Differenziallenkung, da 
	...
	\begin{figure}[!ht]
		...
		\caption{Übersicht der Positionen der Hardware - DC-Antriebsmotor, Fahrtenregler, UBEC, Servo, Akku, Motorshield, Raspberry Pi und Arduino - im rosBerry}
...
benötigt. \\
	...
	\caption{Deutlich späteres Overfitting, bei höherer Bildauflösung, zum 
	Preis von deutlich höherer Rechenzeit pro Epoche. Erste Dropout Schicht 
	wurde eingeführt. }
	\label{Overfitt }
\end{figure}
...
\end{minted}
		...
		Fehlermeldung bei nicht threadsicherem Aufruf vom Keras Modell}
	\end{figure}
...
with thread_session.as_default():
		...
		Schlüsselworts with verhindert Multithreading Probleme bei Aufruf des 
		Keras Modells}
	\end{figure}
...
Verbindung mit. \\
%hilft die taktung? 
Eine Auffälligkeit im Verhalten des Roboters ist seine \say{Vorliebe} 
