...
roslaunch ki_nav start_AI.launch
	...
	\begin{figure}
		...
		\caption{Auszug aus Hersteller Datenblatt:Lenkservo. Zeigt einen der 
		Zwei Motoren des Roboters. Dieser Servo ist alleine für die Lenkung 
		zuständig. }
		\label{Servomotor}
	\end{figure}
...
model.add(Activation("softmax"))
	...
	\begin{figure}[!h]
		...
		\caption{Erster Durchlauf des Neuronalen Netzes mit dem Beispiel 
...
\end{figure}
	...
	Durchläufen und kleinerer Pixelanzahl erreicht. \\
		...
		\caption{End Ergebnis, nach Nachbesserung des Datensatzes, Dropout 
...
with thread_session.as_default():
		\end{minted}
		\label{with}
		\caption{Verwendung von initialisiertem Graph verhindert Multi 
		theading Probleme bei Aufruf des Keras Modells}
	\end{figure}
...
In der Realität ist anfangs zu beobachten das der Roboter sehr zeitverzögert 
reagiert. Die anfängliche Verzögerung von 3 Sekunden, wächst im laufenden 
...
aus Standart Teilen zu bauen. Die vielfältigen Opensource Hardware 
Produkte die für Maker Hergestellt werden sind zuverlässig genug für den 
Anwendungsfall. Modellbau Hardware jedoch ist wesentlich Fehleranfälliger. 
Dieses Projekt hat bei sachgemässer Nutzung 1 Servo und Zwei Ubeck 
Spannungswandler zerstört.

Bei KIs sind gute Grundannamen unerlässlich. Die Annahme das, dass 
