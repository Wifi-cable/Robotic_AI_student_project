...
\IEEEauthorblockA{\textit{Hochschule Mannheim} \\
email1712806@stud.hs-mannheim.de }
\and
...
\end{itemize}
	...
	Beim ersten Durchlauf der des Neuronalen Netzes war die Erkrankungsrate des Markers 57\% . Dieses Ergebnis ist bei einer 50/50 Chance kaum besser als raten. Es stellte sich heraus das zwei  haut Faktoren dafür verantwortlich waren. Zum einen waren die Bilder im Trainingset nicht ausführlich genug sortiert. Das andere Problem lag in der Verwendung der Daten und im benutzen des Netzes.  Das Netz nutzte nur eine Auflösung von 128x128 Pixel und 100 Epochen. Da jedes einzelne Pixel eine Eingangsneurhone wird, ist anzunehmen das die geringe Auflösung im Buch gewählt wurde, um Rechenleistung zu sparen. Bei voller Bild Auflösung von 640x480 Pixel erweist sich das Neuronale Netz  auf der Hardware eines handelsüblichen Laptops als nicht mehr als Lauffähig. 
